...
export const api = {
  ...
  getAgency: (id) => request(`/agency/${id}`),
  sendMessage: (data) =>
  ...
  createProperty: (formData) =>
    fetch(`${API_BASE}/agency/properties`, { method: 'POST', body: formData, credentials: 'include' }),
  updateProperty: (id, formData) =>
    fetch(`${API_BASE}/agency/properties/${id}`, { method: 'PUT', body: formData, credentials: 'include' }),
  deleteProperty: (id) =>
